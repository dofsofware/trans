        ...
        <div className="mt-4 space-y-2">
          ...
          <div className="pt-3 mt-3 border-t border-gray-100 flex justify-between">
            <div className="text-xs font-medium text-gray-500">
              {t('weight')}: <span className="text-gray-900">{shipment.weight.toLocaleString()} kg</span>
            </div>
            <div className="text-xs font-medium text-gray-500">
              {t('volume')}: <span className="text-gray-900">{shipment.volume.toLocaleString()} m³</span>
            </div>
          </div>
        </div>
      </div>
